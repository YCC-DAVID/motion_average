...
{
	x1 = affpara[0] + x * affpara[1] + y * affpara[2]; y1 = affpara[3] + x * affpara[4] + y * affpara[5];
}
...
{
	double corner2[8] = {0}; 
	corner2[0] = 0;							  corner2[4] = 0; 
	corner2[1] = imgwidth - 1;				  corner2[5] = 0;
	corner2[2] = imgwidth - 1;				  corner2[6] = imgheight - 1;
	corner2[3] = 0;							  corner2[7] = imgheight - 1;
...
{ // affpara has 6 parameters. 
	...
	for (int p = 0; p < pdata1->GetRasterCount(); p++)
