...
cxxopts::Options parseOptions(std::string exepath = "")
{
	...
	options.add_options()("gt", "input BundleGraph file as Ground Truth", cxxopts::value<std::string>())
...
int main(int argc, char** argv)
{
	...
	{
		if (fs::exists(p)) graphlist.push_back(p);
		else logg::warn("Skip {}: not exists", p);
	}
